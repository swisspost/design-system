...
`@swisspost/design-system-components-react/server` and `@swisspost/design-system-components-react/server/post-accordion` exports, are kept as the explicit server entries.
