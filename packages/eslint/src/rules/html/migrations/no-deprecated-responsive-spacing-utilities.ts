import {
  createResponsiveClassUpdateRule,
  ResponsiveClassMapping,
} from '../../../utils/create-responsive-class-update-rule';
...
const classesMap: ResponsiveClassMapping[] = prefixes.flatMap(prefix =>
