...
htmlRuleTester.run(name, rule, {
  ...
  invalid: [
    {
      code: '<button class="btn btn-rg" testattr test-attr1="" test-attr2="">Click me</button> ',
      output: '<button class="btn btn-sm" testattr test-attr1="" test-attr2="">Click me</button> ',
      errors: ERROR,
    },
    {
