...
| `showHomeText`                 | `show-home-text`   | Whether `text-home` content is displayed instead of the home icon, enabling segment specific breadcrumbs (like "Private customers" or "About us").                                                                                                        | `boolean` | `false`     |
