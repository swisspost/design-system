...
| `label`     | `label`      | The accessible label for the Content Tabs variant.                                                                                                                             | `string`             | `undefined` |                                                                                                                | `string`  | `undefined`            |
| `textNextTabItems` | `text-next-tab-items` | Label for the "next tab items" button.                                                                                                                                         | `string`  | `'Next tab items'`     |
| `textPrevTabItems` | `text-prev-tab-items` | Label for the "previous tab items" button.    
| `size`      | `size`       | The size of the tabs, corresponding to the different designs in Figma. Default is 'large'.       | `string`  | `'Previous tab items'` |
