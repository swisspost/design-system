 ...
 * @slot icon - To insert a custom icon into the named `icon` slot.<p>Markup accepted: <a href="https://developer.mozilla.org/en-US/docs/Glossary/Inline-level_content">inline content</a>.<post-banner data-size="sm">It is only meant for <code>img</code> or <code>svg</code> elements and overrides the `icon` property.</post-banner>
 */
@Component({
...
export class PostCardControl {
   ...
   * <post-banner data-size="sm">This is a required property, when the control should participate in a native `form`. If not specified, a native `form` will never contain this controls value.</post-banner>
   * <post-banner data-size="sm">This is a required property, when the control is used with type `radio`.</post-banner>
   */
  @Prop() readonly name?: string;

  /**
   * Defines the `value` attribute of the control. <post-banner data-size="sm">This is a required property, when the control is used with type `radio`.</post-banner>
   */
   ...
   * <post-banner data-size="sm">If not set the icon will not show up.</post-banner>
   */
   ...
   * An event emitted whenever the components checked state is toggled.
   * The event payload (emitted under `event.detail.state`) is a boolean: `true` if the component is checked, `false` if it is unchecked.
   * <post-banner data-size="sm">If the component is used with type `radio`, it will only emit this event, when the checked state is changing to `true`.</post-banner>
   */
