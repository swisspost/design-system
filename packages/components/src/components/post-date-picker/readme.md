...
| `locale`                          | `locale`               | The date picker's selected locale (e.g. "it" or "it-CH"). <br>Note: The Date Picker popup may not support the configured language and fall back to English, the right locale is important anyway to get the correct date format and text direction! | `string`                                                                                                         | `this.systemLocale` |
