...
| ------------- | ------------- | ---------------------------------------------------------------------- | --------------- | ----------- |
| `description` | `description` | ARIA description for additional context, read after `text` or `label`. | `string`        | `undefined` |
| `label`       | `label`       | ARIA label, screen readers will use this instead of `text`.            | `string`        | `undefined` |
