...
export namespace Components {
    ...
    interface PostCardControl {
        ...
        /**
          * Defines the icon `name` inside the card. <post-banner data-size="sm">If not set the icon will not show up.</post-banner>
         */
        "icon"?: string;
        /**
        ...
        "label": string;
        /**
          * Defines the `name` attribute of the control. <post-banner data-size="sm">This is a required property, when the control should participate in a native `form`. If not specified, a native `form` will never contain this controls value.</post-banner> <post-banner data-size="sm">This is a required property, when the control is used with type `radio`.</post-banner>
         */
        "name"?: string;
        /**
...
declare namespace LocalJSX {
    ...
    interface PostCardControl {
        ...
        "name"?: string;
        /**
          * An event emitted whenever the components checked state is toggled. The event payload (emitted under `event.detail.state`) is a boolean: `true` if the component is checked, `false` if it is unchecked. <post-banner data-size="sm">If the component is used with type `radio`, it will only emit this event, when the checked state is changing to `true`.</post-banner>
         */
