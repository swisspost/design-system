...
declare global {
  ...
  interface HTMLPostClosebuttonElement extends Components.PostClosebutton, HTMLStencilElement {
    addEventListener<K extends keyof HTMLPostClosebuttonElementEventMap>(
      type: K,
      listener: (
        this: HTMLPostClosebuttonElement,
        ev: PostClosebuttonCustomEvent<HTMLPostClosebuttonElementEventMap[K]>,
      ) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLPostClosebuttonElementEventMap>(
      type: K,
      listener: (
        this: HTMLPostClosebuttonElement,
        ev: PostClosebuttonCustomEvent<HTMLPostClosebuttonElementEventMap[K]>,
  ...
  interface HTMLPostLanguageOptionElement
    extends Components.PostLanguageOption,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLPostLanguageOptionElementEventMap>(
      type: K,
      listener: (
        this: HTMLPostLanguageOptionElement,
        ev: PostLanguageOptionCustomEvent<HTMLPostLanguageOptionElementEventMap[K]>,
      ) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLPostLanguageOptionElementEventMap>(
      type: K,
      listener: (
        this: HTMLPostLanguageOptionElement,
        ev: PostLanguageOptionCustomEvent<HTMLPostLanguageOptionElementEventMap[K]>,
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'post-language-option': LocalJSX.PostLanguageOption &
        JSXBase.HTMLAttributes<HTMLPostLanguageOptionElement>;
      'post-language-switch': LocalJSX.PostLanguageSwitch &
        JSXBase.HTMLAttributes<HTMLPostLanguageSwitchElement>;
