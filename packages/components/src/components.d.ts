...
declare global {
  ...
  interface HTMLPostSideNavigationElement
    extends Components.PostSideNavigation, HTMLStencilElement {
  ...
  interface HTMLPostSideNavigationTriggerElement
    extends Components.PostSideNavigationTrigger, HTMLStencilElement {}
...
declare namespace LocalJSX {
  ...
  interface IntrinsicElements {
    'post-accordion': Omit<PostAccordion, keyof PostAccordionAttributes> & {
      ...
      [
        K in keyof PostAccordion & keyof PostAccordionAttributes as `attr:${K}`
      ]?: PostAccordionAttributes[K];
    } & {
    ...
    'post-accordion-item': Omit<PostAccordionItem, keyof PostAccordionItemAttributes> & {
      ...
      [
        K in keyof PostAccordionItem & keyof PostAccordionItemAttributes as `attr:${K}`
      ]?: PostAccordionItemAttributes[K];
    } & {
      [
        K in keyof PostAccordionItem & keyof PostAccordionItemAttributes as `prop:${K}`
      ]?: PostAccordionItem[K];
    };
    'post-autocomplete': Omit<PostAutocomplete, keyof PostAutocompleteAttributes> & {
      ...
      [
        K in keyof PostAutocomplete & keyof PostAutocompleteAttributes as `attr:${K}`
      ]?: PostAutocompleteAttributes[K];
    } & {
      [
        K in keyof PostAutocomplete & keyof PostAutocompleteAttributes as `prop:${K}`
      ]?: PostAutocomplete[K];
    } & OneOf<
    ...
    'post-back-to-top': Omit<PostBackToTop, keyof PostBackToTopAttributes> & {
      ...
      [
        K in keyof PostBackToTop & keyof PostBackToTopAttributes as `attr:${K}`
      ]?: PostBackToTopAttributes[K];
    } & {
    ...
    'post-breadcrumb-item': Omit<PostBreadcrumbItem, keyof PostBreadcrumbItemAttributes> & {
      ...
      [
        K in keyof PostBreadcrumbItem & keyof PostBreadcrumbItemAttributes as `attr:${K}`
      ]?: PostBreadcrumbItemAttributes[K];
    } & {
      [
        K in keyof PostBreadcrumbItem & keyof PostBreadcrumbItemAttributes as `prop:${K}`
      ]?: PostBreadcrumbItem[K];
    };
    'post-breadcrumbs': Omit<PostBreadcrumbs, keyof PostBreadcrumbsAttributes> & {
      ...
      [
        K in keyof PostBreadcrumbs & keyof PostBreadcrumbsAttributes as `attr:${K}`
      ]?: PostBreadcrumbsAttributes[K];
    } & {
      [
        K in keyof PostBreadcrumbs & keyof PostBreadcrumbsAttributes as `prop:${K}`
      ]?: PostBreadcrumbs[K];
    ...
    'post-closebutton': Omit<PostClosebutton, keyof PostClosebuttonAttributes> & {
      ...
      [
        K in keyof PostClosebutton & keyof PostClosebuttonAttributes as `attr:${K}`
      ]?: PostClosebuttonAttributes[K];
    } & {
      [
        K in keyof PostClosebutton & keyof PostClosebuttonAttributes as `prop:${K}`
      ]?: PostClosebutton[K];
    };
    'post-collapsible': Omit<PostCollapsible, keyof PostCollapsibleAttributes> & {
      ...
      [
        K in keyof PostCollapsible & keyof PostCollapsibleAttributes as `attr:${K}`
      ]?: PostCollapsibleAttributes[K];
    } & {
      [
        K in keyof PostCollapsible & keyof PostCollapsibleAttributes as `prop:${K}`
      ]?: PostCollapsible[K];
    };
    ...
    > & {
      [
        K in keyof PostCollapsibleTrigger & keyof PostCollapsibleTriggerAttributes
      ]?: PostCollapsibleTrigger[K];
    } & {
      [
        K in keyof PostCollapsibleTrigger & keyof PostCollapsibleTriggerAttributes as `attr:${K}`
      ]?: PostCollapsibleTriggerAttributes[K];
    } & {
      [
        K in keyof PostCollapsibleTrigger & keyof PostCollapsibleTriggerAttributes as `prop:${K}`
      ]?: PostCollapsibleTrigger[K];
    };
    'post-date-picker': Omit<PostDatePicker, keyof PostDatePickerAttributes> & {
      ...
      [
        K in keyof PostDatePicker & keyof PostDatePickerAttributes as `attr:${K}`
      ]?: PostDatePickerAttributes[K];
    } & {
      [
        K in keyof PostDatePicker & keyof PostDatePickerAttributes as `prop:${K}`
      ]?: PostDatePicker[K];
    } & OneOf<
        'textNextMonth',
    ...
    'post-language-menu': Omit<PostLanguageMenu, keyof PostLanguageMenuAttributes> & {
      ...
      [
        K in keyof PostLanguageMenu & keyof PostLanguageMenuAttributes as `attr:${K}`
      ]?: PostLanguageMenuAttributes[K];
    } & {
      [
        K in keyof PostLanguageMenu & keyof PostLanguageMenuAttributes as `prop:${K}`
      ]?: PostLanguageMenu[K];
    } & OneOf<
        'textChangeLanguage',
    ...
    'post-language-menu-item': Omit<PostLanguageMenuItem, keyof PostLanguageMenuItemAttributes> & {
      [
        K in keyof PostLanguageMenuItem & keyof PostLanguageMenuItemAttributes
      ]?: PostLanguageMenuItem[K];
    } & {
      [
        K in keyof PostLanguageMenuItem & keyof PostLanguageMenuItemAttributes as `attr:${K}`
      ]?: PostLanguageMenuItemAttributes[K];
    } & {
      [
        K in keyof PostLanguageMenuItem & keyof PostLanguageMenuItemAttributes as `prop:${K}`
      ]?: PostLanguageMenuItem[K];
    ...
    'post-listbox-option': Omit<PostListboxOption, keyof PostListboxOptionAttributes> & {
      ...
      [
        K in keyof PostListboxOption & keyof PostListboxOptionAttributes as `attr:${K}`
      ]?: PostListboxOptionAttributes[K];
    } & {
      [
        K in keyof PostListboxOption & keyof PostListboxOptionAttributes as `prop:${K}`
      ]?: PostListboxOption[K];
    ...
    'post-mainnavigation': Omit<PostMainnavigation, keyof PostMainnavigationAttributes> & {
      ...
      [
        K in keyof PostMainnavigation & keyof PostMainnavigationAttributes as `attr:${K}`
      ]?: PostMainnavigationAttributes[K];
    } & {
      [
        K in keyof PostMainnavigation & keyof PostMainnavigationAttributes as `prop:${K}`
      ]?: PostMainnavigation[K];
    ...
    'post-megadropdown': Omit<PostMegadropdown, keyof PostMegadropdownAttributes> & {
      ...
      [
        K in keyof PostMegadropdown & keyof PostMegadropdownAttributes as `attr:${K}`
      ]?: PostMegadropdownAttributes[K];
    } & {
      [
        K in keyof PostMegadropdown & keyof PostMegadropdownAttributes as `prop:${K}`
      ]?: PostMegadropdown[K];
    ...
    > & {
      ...
      ]?: PostMegadropdownTrigger[K];
    } & {
      [
        K in keyof PostMegadropdownTrigger & keyof PostMegadropdownTriggerAttributes as `attr:${K}`
      ]?: PostMegadropdownTriggerAttributes[K];
    } & {
      [
        K in keyof PostMegadropdownTrigger & keyof PostMegadropdownTriggerAttributes as `prop:${K}`
      ]?: PostMegadropdownTrigger[K];
    ...
    'post-menu-trigger': Omit<PostMenuTrigger, keyof PostMenuTriggerAttributes> & {
      ...
      [
        K in keyof PostMenuTrigger & keyof PostMenuTriggerAttributes as `attr:${K}`
      ]?: PostMenuTriggerAttributes[K];
    } & {
      [
        K in keyof PostMenuTrigger & keyof PostMenuTriggerAttributes as `prop:${K}`
      ]?: PostMenuTrigger[K];
    ...
    'post-pagination': Omit<PostPagination, keyof PostPaginationAttributes> & {
      ...
      [
        K in keyof PostPagination & keyof PostPaginationAttributes as `attr:${K}`
      ]?: PostPaginationAttributes[K];
    } & {
      [
        K in keyof PostPagination & keyof PostPaginationAttributes as `prop:${K}`
      ]?: PostPagination[K];
    ...
    'post-popover': Omit<PostPopover, keyof PostPopoverAttributes> & {
      ...
      [
        K in keyof PostPopover & keyof PostPopoverAttributes as `attr:${K}`
      ]?: PostPopoverAttributes[K];
    } & {
    ...
    'post-popover-trigger': Omit<PostPopoverTrigger, keyof PostPopoverTriggerAttributes> & {
      ...
      [
        K in keyof PostPopoverTrigger & keyof PostPopoverTriggerAttributes as `attr:${K}`
      ]?: PostPopoverTriggerAttributes[K];
    } & {
      [
        K in keyof PostPopoverTrigger & keyof PostPopoverTriggerAttributes as `prop:${K}`
      ]?: PostPopoverTrigger[K];
    };
    'post-popovercontainer': Omit<PostPopovercontainer, keyof PostPopovercontainerAttributes> & {
      [
        K in keyof PostPopovercontainer & keyof PostPopovercontainerAttributes
      ]?: PostPopovercontainer[K];
    } & {
      [
        K in keyof PostPopovercontainer & keyof PostPopovercontainerAttributes as `attr:${K}`
      ]?: PostPopovercontainerAttributes[K];
    } & {
      [
        K in keyof PostPopovercontainer & keyof PostPopovercontainerAttributes as `prop:${K}`
      ]?: PostPopovercontainer[K];
    };
    'post-progressbar': Omit<PostProgressbar, keyof PostProgressbarAttributes> & {
      ...
      [
        K in keyof PostProgressbar & keyof PostProgressbarAttributes as `attr:${K}`
      ]?: PostProgressbarAttributes[K];
    } & {
      [
        K in keyof PostProgressbar & keyof PostProgressbarAttributes as `prop:${K}`
      ]?: PostProgressbar[K];
    };
    ...
    'post-side-navigation': Omit<PostSideNavigation, keyof PostSideNavigationAttributes> & {
      ...
      [
        K in keyof PostSideNavigation & keyof PostSideNavigationAttributes as `attr:${K}`
      ]?: PostSideNavigationAttributes[K];
    } & {
      [
        K in keyof PostSideNavigation & keyof PostSideNavigationAttributes as `prop:${K}`
      ]?: PostSideNavigation[K];
    } & OneOf<
        'textClose',
    ...
    > & {
      [
        K in keyof PostSideNavigationTrigger & keyof PostSideNavigationTriggerAttributes
      ]?: PostSideNavigationTrigger[K];
    } & {
      [
        K in keyof PostSideNavigationTrigger &
          keyof PostSideNavigationTriggerAttributes as `attr:${K}`
      ]?: PostSideNavigationTriggerAttributes[K];
    } & {
      [
        K in keyof PostSideNavigationTrigger &
          keyof PostSideNavigationTriggerAttributes as `prop:${K}`
      ]?: PostSideNavigationTrigger[K];
    ...
    'post-stepper': Omit<PostStepper, keyof PostStepperAttributes> & {
      ...
      [
        K in keyof PostStepper & keyof PostStepperAttributes as `attr:${K}`
      ]?: PostStepperAttributes[K];
    } & {
    ...
    'post-tab-item': Omit<PostTabItem, keyof PostTabItemAttributes> & {
      ...
      [
        K in keyof PostTabItem & keyof PostTabItemAttributes as `attr:${K}`
      ]?: PostTabItemAttributes[K];
    } & {
    ...
    'post-tab-panel': Omit<PostTabPanel, keyof PostTabPanelAttributes> & {
      ...
      [
        K in keyof PostTabPanel & keyof PostTabPanelAttributes as `attr:${K}`
      ]?: PostTabPanelAttributes[K];
    } & {
    ...
    'post-togglebutton': Omit<PostTogglebutton, keyof PostTogglebuttonAttributes> & {
      ...
      [
        K in keyof PostTogglebutton & keyof PostTogglebuttonAttributes as `attr:${K}`
      ]?: PostTogglebuttonAttributes[K];
    } & {
      [
        K in keyof PostTogglebutton & keyof PostTogglebuttonAttributes as `prop:${K}`
      ]?: PostTogglebutton[K];
    };
    'post-tooltip': Omit<PostTooltip, keyof PostTooltipAttributes> & {
      ...
      [
        K in keyof PostTooltip & keyof PostTooltipAttributes as `attr:${K}`
      ]?: PostTooltipAttributes[K];
    ...
    'post-tooltip-trigger': Omit<PostTooltipTrigger, keyof PostTooltipTriggerAttributes> & {
      ...
      [
        K in keyof PostTooltipTrigger & keyof PostTooltipTriggerAttributes as `attr:${K}`
      ]?: PostTooltipTriggerAttributes[K];
    } & {
      [
        K in keyof PostTooltipTrigger & keyof PostTooltipTriggerAttributes as `prop:${K}`
      ]?: PostTooltipTrigger[K];
