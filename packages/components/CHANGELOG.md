...
- Made the `<post-rating>` label prop required. (by [@myrta2302](https://github.com/myrta2302) with [#6487](https://github.com/swisspost/design-system/pull/6487))
...
- Updated the `<post-accordion>` and `<post-accordion-item>` styles to fully align with the design specification. As part of this cleanup, the `accordion-item` part has been removed from `<post-accordion-item>`. The component’s styles can now be customized directly by targeting the host or by using the exposed parts for the trigger button and body elements (e.g., `::part(post-accordion-body) { ... }`). (by [@oliverschuerch](https://github.com/oliverschuerch) and [@alizedebray](https://github.com/alizedebray) with [#6676](https://github.com/swisspost/design-system/pull/6676))
...
- Removed the deprecated `headingLevel` property from the `post-accordion-item`. Also removed the autogenerated id, allowing for a custom, manually set id instead. (by [@alizedebray](https://github.com/alizedebray) with [#7949](https://github.com/swisspost/design-system/pull/7949))
...
- Introduced `<post-popover-trigger>` web component to replace the previous `data-popover-target` implementation. (by [@myrta2302](https://github.com/myrta2302), [@hugomslv](https://github.com/hugomslv) and [@alizedebray](https://github.com/alizedebray) with [#6209](https://github.com/swisspost/design-system/pull/6209))
...
- Updated the `post-date-picker` component:
  ...
  - The input mask behavior has also been improved to avoid incorrectly formatted dates. (by [@alizedebray](https://github.com/alizedebray) with [#7955](https://github.com/swisspost/design-system/pull/7955))
...
- Updated the following props to be `required`:
  - `<post-collapsible-trigger>`: `for` is now required.
...
- Removed the `alert-fixed-bottom` variant of the alert (now called `<post-banner>`). (by [@leagrdv](https://github.com/leagrdv) and [@gfellerph](https://github.com/gfellerph) with [#3862](https://github.com/swisspost/design-system/pull/3862))
...
- Made the `heading-level` property required for `<post-accordion>` and removed it from the `<post-accordion-item>` docs. (by [@schaertim](https://github.com/schaertim) and [@alizedebray](https://github.com/alizedebray) with [#3383](https://github.com/swisspost/design-system/pull/3383))
...
- Added a `full-width` property to the `<post-tabs>` component to allow the tabs container to span the full screen width. (by [@myrta2302](https://github.com/myrta2302) and [@alizedebray](https://github.com/alizedebray) with [#5736](https://github.com/swisspost/design-system/pull/5736))
...
- Added the `<post-megadropdown>` component. (by [@leagrdv](https://github.com/leagrdv) and [@alizedebray](https://github.com/alizedebray) with [#4177](https://github.com/swisspost/design-system/pull/4177))

- Added the capability to use a slotted img, such as a logo, inside `<post-accordion-item>`. (by [@leagrdv](https://github.com/leagrdv) with [#4166](https://github.com/swisspost/design-system/pull/4166))
...
- Updated `post-tabs` to support Server-Side Rendering. (by [@myrta2302](https://github.com/myrta2302) with [#7494](https://github.com/swisspost/design-system/pull/7494))

- Added the parts `::part(post-accordion-button)` and `::part(post-accordion-body)` in the `<post-accordion-item>` component, so one can override styles from the outside. (by [@oliverschuerch](https://github.com/oliverschuerch) and [@gfellerph](https://github.com/gfellerph) with [#4190](https://github.com/swisspost/design-system/pull/4190))
...
- Refactored `<post-icon>` component to use the `<use>` tag to load and show icons under the hood. This enables responsive icons, enables better caching and improves render performance slightly. There is no further action required. (by [@oliverschuerch](https://github.com/oliverschuerch) and [@gfellerph](https://github.com/gfellerph) with [#3969](https://github.com/swisspost/design-system/pull/3969))
...
- Enabled the open animation for the `<post-tooltip>` component. (by [@myrta2302](https://github.com/myrta2302) and [@alizedebray](https://github.com/alizedebray) with [#6821](https://github.com/swisspost/design-system/pull/6821))
...
- Added navigation variant to the `<post-tabs>` component, enabling anchor-based navigation. The component now automatically detects whether `<post-tab-item>` elements contain anchor links and switches between Content and Page variants accordingly. For Page Tabs variant, the `aria-current="page"` attribute must be manually added to the anchor element representing the current page to ensure proper styling and accessibility. (by [@alionazherdetska](https://github.com/alionazherdetska) and [@alizedebray](https://github.com/alizedebray) with [#6350](https://github.com/swisspost/design-system/pull/6350))
...
- Added the autocomplete component. `<post-autocomplete>`, `<post-listbox>` and `<post-listbox-option>` are now experimentally ready to be used. A style refinement will follow. (by [@JoaoSequeira489](https://github.com/JoaoSequeira489) and [@gfellerph](https://github.com/gfellerph) with [#7287](https://github.com/swisspost/design-system/pull/7287))
...
- Fixed a bug in nested accordions where closing a child item unintentionally closed all parent accordion elements. (by [@schaertim](https://github.com/schaertim) and [@alizedebray](https://github.com/alizedebray) with [#3427](https://github.com/swisspost/design-system/pull/3427))
...
- Fixed 'Cannot read properties of undefined (reading 'removeEventListener')' error in `<post-popover>` component. (by [@myrta2302](https://github.com/myrta2302) and [@alionazherdetska](https://github.com/alionazherdetska) with [#7224](https://github.com/swisspost/design-system/pull/7224))
...
- Added a check to prevent popup components such as `post-menu`, `post-popover`, and `post-tooltip` from being open without a target element being passed to the method. (by [@alizedebray](https://github.com/alizedebray) with [#7952](https://github.com/swisspost/design-system/pull/7952))
...
- Updated validation error messages across the component library. (by [@myrta2302](https://github.com/myrta2302) and [@alizedebray](https://github.com/alizedebray) with [#5471](https://github.com/swisspost/design-system/pull/5471))

- Made the following components hidden until fully loaded to prevent flickering: `<post-avatar>`, `<post-banner>`, `<post-breadcrumb>`, `<post-breadcrumb-item>`, `<post-closebutton>`, `<post-collapsible-trigger>`, `<post-footer>`, `<post-header>`, `<post-language-menu-item>`, `<post-language-switch>`, `<post-mainnavigation>`, `<post-megadropdown>`, `<post-megadropdown-trigger>`, `<post-menu>`, `<post-menu-item>`, and `<post-menu-trigger>`. (by [@schaertim](https://github.com/schaertim) and [@alizedebray](https://github.com/alizedebray) with [#4544](https://github.com/swisspost/design-system/pull/4544))

- Removed conflicting long press event from tooltips. As of now, tooltips are only supported for pointers and focused elements. Alternatively, use an information button (i) that triggers a popover, which is accessible for all users. The tooltip concept will be improved in a future release and remains partially inaccessible for touch devices. (by [@gfellerph](https://github.com/gfellerph) with [#7930](https://github.com/swisspost/design-system/pull/7930))

- Fixed an issue where components were sometimes not correctly rendered on load because of an incorrect breakpoint found. (by [@alizedebray](https://github.com/alizedebray) with [#7483](https://github.com/swisspost/design-system/pull/7483))

- Fixed range selection styles for 1.25dpr screens. (by [@myrta2302](https://github.com/myrta2302) with [#7980](https://github.com/swisspost/design-system/pull/7980))
...
- Fixed components with missing required properties during hydration phase, when used nested in other components in a SSR environment. (by [@oliverschuerch](https://github.com/oliverschuerch) and [@gfellerph](https://github.com/gfellerph) with [#6635](https://github.com/swisspost/design-system/pull/6635))
...
- Fixed Header megadropdown bottom padding disappearing when scrolled. (by [@myrta2302](https://github.com/myrta2302) with [#7901](https://github.com/swisspost/design-system/pull/7901))
...
- The `<post-accordion-item>` heading level is now inherited from the parent `<post-accordion>` component, falling back to `h2` by default. (by [@oliverschuerch](https://github.com/oliverschuerch) and [@gfellerph](https://github.com/gfellerph) with [#4190](https://github.com/swisspost/design-system/pull/4190))

- Updated the `textCurrentLanguage` of the `post-language-menu` to accept the `{name}` placeholder. The previous `#name` placeholder can still be used but it is deprecated and will be removed in a future version. (by [@alizedebray](https://github.com/alizedebray) and [@alionazherdetska](https://github.com/alionazherdetska) with [#7882](https://github.com/swisspost/design-system/pull/7882))
...
- Reduced the length of random IDs generated in the components; they are now generated using the [nanoid library](https://github.com/ai/nanoid) instead of the [Web Crypto API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Crypto_API). (by [@leagrdv](https://github.com/leagrdv) and [@alizedebray](https://github.com/alizedebray) with [#4369](https://github.com/swisspost/design-system/pull/4369))

- Added the CSS variable `--post-popover-max-width` that enables configuring the max-width of the `<post-popover>` component. (by [@leagrdv](https://github.com/leagrdv) and [@gfellerph](https://github.com/gfellerph) with [#4898](https://github.com/swisspost/design-system/pull/4898))
...
- Added documentation for the `design-system-components-react` package. (by [@leagrdv](https://github.com/leagrdv) and [@alizedebray](https://github.com/alizedebray) with [#4669](https://github.com/swisspost/design-system/pull/4669))
...
- Fixed the way the icon url gets generated in the `<post-icon>` component. (by [@oliverschuerch](https://github.com/oliverschuerch) and [@gfellerph](https://github.com/gfellerph) with [#4351](https://github.com/swisspost/design-system/pull/4351))
...
- Made `<post-icon>` component use base tag href to define location of icons folder. (by [@leagrdv](https://github.com/leagrdv) with [#4166](https://github.com/swisspost/design-system/pull/4166))

- Fixed import-time side effects in `<post-tooltip-trigger>` by lazy-loading `ally.js`. (by [@oliverschuerch](https://github.com/oliverschuerch) with [#7660](https://github.com/swisspost/design-system/pull/7660))

- Replaced thrown errors with console.errors for all property checker functions. (by [@myrta2302](https://github.com/myrta2302) and [@alizedebray](https://github.com/alizedebray) with [#5471](https://github.com/swisspost/design-system/pull/5471))
...
- Updated the following props to be `optional`:
  - `<post-logo>`: `url`
  - `<post-tabs>`: `activePanel` (by [@myrta2302](https://github.com/myrta2302) with [#5469](https://github.com/swisspost/design-system/pull/5469))
...
- Updated `<post-popovercontainer>` to fix a tooltip desynchronization issue when hovering quickly in and out. (by [@myrta2302](https://github.com/myrta2302) with [#6607](https://github.com/swisspost/design-system/pull/6607))
- Updated dependencies:
