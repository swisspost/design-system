...
- Added the post-logo component, which enables displaying the Post's logo either as a clickable link or as a simple image. (by [@oliverschuerch](https://github.com/oliverschuerch) with [#3465](https://github.com/swisspost/design-system/pull/3465))

### Patch Changes

- Fixed the `post-card-control` component to use the correct color scheme when placed on nested colored backgrounds. (by [@oliverschuerch](https://github.com/oliverschuerch) with [#3465](https://github.com/swisspost/design-system/pull/3465))

- Simplified individual web component imports. (by [@alizedebray](https://github.com/alizedebray) with [#3406](https://github.com/swisspost/design-system/pull/3406))

- Fixed the post-tabs component throwing an error when imported individually. (by [@alizedebray](https://github.com/alizedebray) with [#3407](https://github.com/swisspost/design-system/pull/3407))
