...
const COMPONENTS: Array<{ id: string; stories: string[]; tags: TagEntry[] }> = [
  { id: '4d1b4185-e04d-494a-ab38-2b56c1778b0b', stories: ['default'], tags: ['post-accordion'] },
  { id: '5ef3cb45-86f6-4baf-bdbf-35bd2ddf0f3d', stories: ['default'], tags: ['post-autocomplete'] },
  { id: '09aac03d-220e-4885-8fb8-1cfa01add188', stories: ['default'], tags: ['post-avatar'] },
  {
    id: '1a1b4cab-d0a8-4b01-bd85-b70e18668cb5',
    stories: ['default'],
    tags: [{ tag: 'post-back-to-top', options: { noTitle: true } }],
  },
  { id: '105e67d8-31e9-4d0b-87ff-685aba31fd4c', stories: ['default'], tags: ['post-banner'] },
  { id: 'b7db7391-f893-4b1e-a125-b30c6f0b028b', stories: ['default'], tags: ['post-breadcrumbs'] },
  { id: 'de313349-0c0b-4baf-adc6-cb8c2e36fc1a', stories: ['default'], tags: ['post-closebutton'] },
  {
  ...
  { id: 'eb77cd02-48b2-42e1-a3e4-cd8a973d431e', stories: ['default'], tags: ['post-date-picker'] },
  { id: 'd97528b3-a9ef-4201-bf28-9caf6e8997dc', stories: ['default'], tags: ['post-footer'] },
  { id: '27a2e64d-55ba-492d-ab79-5f7c5e818498', stories: ['default'], tags: ['post-header'] },
  { id: '0dcfe3c0-bfc0-4107-b43b-7e9d825b805f', stories: ['default'], tags: ['post-icon'] },
  ...
  { id: 'd5f43fa8-42ba-4cb9-98c7-9386d4c939bb', stories: ['default'], tags: ['post-number-input'] },
  { id: 'd6f8b5c7-4e2a-4f3a-9d3a-1a2b3c4d5e6f', stories: ['default'], tags: ['post-pagination'] },
  {
  ...
  { id: '956e063b-b40c-4fe4-bc27-53b8c4ab1e81', stories: ['default'], tags: ['post-rating'] },
  { id: '7dc546d9-e248-4d06-befe-3ad62fcd310f', stories: ['default'], tags: ['post-stepper'] },
  { id: 'bb1291ca-4dbb-450c-a15f-596836d9f39e', stories: ['default'], tags: ['post-tabs'] },
  { id: '1a6f47c2-5e8a-45a0-b1c3-9f7e2b834c24', stories: ['default'], tags: ['post-togglebutton'] },
  {
      ...
      it(`should extract markup for ${name} (${story})`, () => {
        ...
        tags.forEach(entry => {
          ...
          cy.get(tag)
            ...
            .then(html => cy.writeMarkup(tag, html, options));
        });
      });
    });
  });
