import { PostBackToTop, PostBreadcrumbItem, PostBreadcrumbs } from '@swisspost/design-system-components-react/server';
    ...
    <>
      ...
      <main style={{ paddingBlock: '3rem' }}>
        <div className="container" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          <PostBreadcrumbs homeUrl="/" text-home="Home" text-breadcrumbs="Breadcrumbs" text-more-items="More items">
