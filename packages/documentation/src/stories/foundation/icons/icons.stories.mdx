...
You can therefore colorize an icon using our [text color utilities](/?path=/docs/utilities-text--color) or by setting the CSS directly through a style attribute or self-defined classes.
