...
import formBadSample from './form-bad.example.ts?raw';
import formGoodSample from './form-good.example.ts?raw';
...
<table className="table caption-top">
  ...
  <tbody>
    ...
    <tr>
      <td colSpan="2" class="fw-bold">Form bad example</td>
    </tr>
    <tr>
      <td><Canvas of={AccessibilityStories.FormBadExample}/></td>
      <td><div class="mt-4"><Source code={formBadSample} language="ts" /></div></td>
    </tr>
     <tr>
      <td colSpan="2" class="fw-bold">Form good example</td>
    </tr>
    <tr>
      <td><Canvas of={AccessibilityStories.FormGoodExample}/></td>
      <td><div class="mt-4"><Source code={formGoodSample} language="ts" /></div></td>
    </tr>
  </tbody>
</table>
