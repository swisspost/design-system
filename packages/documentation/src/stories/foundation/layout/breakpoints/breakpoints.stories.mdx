...
import { BreakpointTable, SCSS_VARIABLES, BreakpointCount } from './breakpoints.blocks';
...
The SwissPost Design-System includes <BreakpointCount/> breakpoints, sometimes referred to as grid tiers, for building responsively. These breakpoints can be customized if you’re using our source Sass files.
