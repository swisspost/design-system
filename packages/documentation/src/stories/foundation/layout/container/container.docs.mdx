...
Containers give resonsive paddign and margins to contents on a webpage. As our Grid is Based on Bootstrap negative Margins are used. Therefore Containers are required to wrap the Grid to prevent unintended side-effects.
