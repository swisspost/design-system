...
<section className="color-swatch__section">
  {forEach(SCSS_VARIABLES.signal, function (data) {
    return <ColorSwatch key={data.key} name={data.key} color={data.value} />;
  })}
</section>
...
<section className="color-swatch__section">
  {forEach(SCSS_VARIABLES['black-alpha'], function (data) {
    return <ColorSwatch key={data.key} name={data.key} color={data.value} />;
  })}
</section>
...
<section className="color-swatch__section">
  {forEach(SCSS_VARIABLES['white-alpha'], function (data) {
    return <ColorSwatch key={data.key} name={data.key} color={data.value} dark />;
  })}
</section>
...
<section className="color-swatch__section">
  {forEach(SCSS_VARIABLES.focus, function (data) {
