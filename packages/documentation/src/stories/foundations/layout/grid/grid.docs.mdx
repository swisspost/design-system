...
import meta, * as GridStories from './grid.stories';
...
<post-banner type="warning">
  <p slot="heading">Don't put a single column in a grid</p>
...
<post-banner class="my-24">
  You can find additional information and examples in the <a href="/?path=/docs/64b63483-79fa-4e9f-9441-f7d6b2eabae2--docs">gutters documentation</a>.
</post-banner>
