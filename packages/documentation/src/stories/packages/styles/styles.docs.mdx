...
<div className="lead">
  The styling package, including theming for [Bootstrap](https://getbootstrap.com/) and
  [ng-bootstrap](https://ng-bootstrap.github.io/#/home) components.
</div>
  ...
  <div className="table-responsive table-fit-content text-start">
    <table aria-describedby="dependencies" className="table">
      ...
      <tbody>
        <tr>
          <th scope="col">10.x</th>
          <td>5.3 (will be removed)</td>
          <td>19.x</td>
          <td>17.x || 18.x (will be removed)</td>
        </tr>
        <tr>
          <th scope="col">9.x</th>
          <td>5.3</td>
...
<div className="banner banner-info banner-md mb-16">
