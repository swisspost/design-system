...
<PackageDocs changelog={changelog}>
  <div className="card my-40">
    <div className="card-body">
      ...
      <h6>Step 1</h6>
      <p className="fs-regular">Integration of header only: contact  <a className="link-warning" href="mailto:dm-tec@post.ch" rel="noopener">dm-tec@post.ch <post-icon name="1001" className="fs-large" /></a> directly</p>
      ...
      <ul className="fs-regular">
        ...
        <li>Categories for the Online Service (see <a className="link-warning" href="https://www.post.ch/de/kundencenter/onlinedienste#t=AllOSTab&sort=%40servicez32xname%20ascending" rel="noopener">https://www.post.ch/de/kundencenter/onlinedienste#t=AllOSTab&sort=%40servicez32xname%20ascending</a> for a list)</li>
        ...
        <li>Abstract in all available languages (will be shown on <a className="link-warning" href="https://www.post.ch/de/kundencenter/onlinedienste#t=AllOSTab&sort=%40servicez32xname%20ascending" rel="noopener">https://www.post.ch/de/kundencenter/onlinedienste#t=AllOSTab&sort=%40servicez32xname%20ascending</a>)</li>
      </ul>
