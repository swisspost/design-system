...
<PackageDocs changelog={changelog}>
  ...
  - For improved semantic markup, consider wrapping the main page content in a `<main>` tag. ([Learn more about the `<main>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/main)).
