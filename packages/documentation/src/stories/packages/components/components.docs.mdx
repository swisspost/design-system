...
<PackageDocs changelog={changelog}>
  ...
  <PostTabs>
    <PostTabHeader panel="lazy-loaded">Lazy-Loaded</PostTabHeader>
    ...
    <PostTabHeader panel="bare-component">Bare component</PostTabHeader>
    <PostTabPanel name="bare-component">
