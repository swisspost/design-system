...
import SampleCssGlobal from './components-css-global.sample.css?raw';
...
<PackageDocs changelog={changelog}>
  ...
  If you are not using any bundler or don't want to install from npm, you can load our components from a CDN. <a href="https://en.wikipedia.org/wiki/Content_delivery_network" rel="noopener">(More on CDNs)</a><br/>
