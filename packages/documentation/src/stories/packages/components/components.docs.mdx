...
<PackageDocs changelog={changelog}>
  ...
  <post-tabs>
    <post-tab-header panel="library">Component Library</post-tab-header>
    <post-tab-panel name="library">
      ...
      <post-tabs>
        <post-tab-header panel="jsdelivr">jsDelivr</post-tab-header>
        <post-tab-panel name="jsdelivr">
          <Source code={SampleLibraryCdnJsdelivr} language="html" />
        </post-tab-panel>

        <post-tab-header panel="unpkg">unpkg</post-tab-header>
        <post-tab-panel name="unpkg">
    ...
    <post-tab-header panel="standalone">Standalone Components</post-tab-header>
    <post-tab-panel name="standalone">
