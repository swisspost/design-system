...
### Icons
The package now includes generated React Server Component icon exports built from `@swisspost/design-system-icons`, therefore it's no longer necessary to have the icons package installed as a dependency to use icons. Import react- and SSR-ready icons directly like:
