...
<PackageDocs changelog={changelog}>
  ...
  <post-tabs>
    <post-tab-header panel="nodeNew">NodeJS version 16.7.0 or newer</post-tab-header>
    <post-tab-panel name="nodeNew">
      <Source  code={SampleNode16} language="json"/>
    </post-tab-panel>

    <post-tab-header panel="nodeOld">Older NodeJS versions</post-tab-header>
    <post-tab-panel name="nodeOld">
  ...
  <post-tabs>
    <post-tab-header panel="metaTag">Meta-tag solution (recommended)</post-tab-header>
    <post-tab-panel name="metaTag">
      <Source code={SampleIconMeta} language="html" />
    </post-tab-panel>

    <post-tab-header panel="baseAttribute">Base-attribute solution</post-tab-header>
    <post-tab-panel name="baseAttribute">
