...
<Canvas dark>
  <Story id="icons-icon-component--default" />
</Canvas>
<ArgsTable story="^" />
...
<Canvas dark withSource="open">
  <Story id="icons-icon-component--color" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="icons-icon-component--size" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="icons-icon-component--style" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="icons-icon-component--flip" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="icons-icon-component--scale" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="icons-icon-component--rotate" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="icons-icon-component--animate" />
</Canvas>
