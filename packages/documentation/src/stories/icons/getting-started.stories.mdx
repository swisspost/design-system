...
This means basically, that you need to copy & paste them manually or automated from the `node_modules` folder to a served folder in your project.
How to do this depends strongly on your project setup.
  ...
  "projects": {
    "name-of-your-angular-app": {
      "architect": {
        "build": {
          "options": {
            "assets": ["node_modules/@swisspost/design-system-icons/public/post-icons"]
          }
        }
      }
    }
