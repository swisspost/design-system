...
<ul className="stakeholders-list col-12 col-md-4 col-lg-3">
  {stakeholders.map((stakeholder, index) => (
    <li key={index} className="stakeholder-item">{stakeholder.role}</li>
  ))}
</ul>
...
<ul className="team-list row">
  {teamMembers.map((teamMember, index) => (
    <li key={index} className="team-item col-12 col-sm-12 col-md-3 col-lg-3 flex-lg-column">
...
<div className="onboarding-info">
  <post-icon name="2022" className="onboarding-icon"></post-icon>
