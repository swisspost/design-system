...
<div class="card my-40">
  <div class="card-body">
    ...
    <h6>Step 1</h6>
    <p class="fs-regular">Integration of header only: contact  <a className="link-warning" href="mailto:dm-tec@post.ch" rel="noopener">dm-tec@post.ch <post-icon name="1001" className="fs-large" /></a> directly</p>
