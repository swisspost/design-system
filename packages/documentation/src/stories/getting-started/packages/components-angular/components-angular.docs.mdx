...
import AngularAppStandaloneSample from './angular-app-standalone-main.sample.ts?raw';
import AngularAppStandaloneComponentSample from './angular-app-standalone-component.sample.ts?raw';
...
<Source code={AngularAppStandaloneSample} language="typescript" />

Usage within your component.

<Source code={AngularAppStandaloneComponentSample} language="typescript" />


## Module-based application usage
