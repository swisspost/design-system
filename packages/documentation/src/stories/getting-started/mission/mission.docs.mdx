...
<post-menu-toggle>
<button class="btn btn-primary" data-menu-target="menu-one">Open Menu</button>
</post-menu-toggle>
<post-menu id="menu-one" placement="bottom-start">
  <post-menu-item href="#">Profile</post-menu-item>
  <post-menu-item><button>Settings</button></post-menu-item>
  <post-menu-item><button>Logout</button></post-menu-item>
</post-menu>
