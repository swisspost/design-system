...
<p className="lead">HTML lists allow web developers to group a set of related items in lists.</p>

There are three main types of lists, from which you can choose the one that best suits your needs.
Our utilities give you the possibility to visualize them in different ways.
...
<Canvas>
  <Story name="Unordered List">
    <ul>
      ...
      <li>
        Therefore it should be rendered with a bulletpoint at the beginning of each list item.
      </li>
      <li>
        Nested list:
        <ul>
