  ...
  return (
    <FlexDocContainer name={props.name} prefix="flex">
      <div className={`d-flex flex-${props.name}`}>
        <div className="p-12">First content</div>
        <div className="p-12">Second content</div>
      </div>
    </FlexDocContainer>
  );
}
  ...
  return (
    <FlexDocContainer name={props.name} prefix="align-items">
      <div className={`d-flex align-items-${props.name}`}>
        <div className="p-12">Small content</div>
        <div className="px-12 py-48">Big content</div>
      </div>
    </FlexDocContainer>
  );
}
  ...
  return (
    <FlexDocContainer name={props.name} prefix="align-self">
      <div className="d-flex align-items-start">
        <div className="px-12 py-48">Content</div>
        <div className={`p-12 align-self-${props.name}`}>Content with align-self</div>
        <div className="px-12 py-48">Content</div>
      </div>
    </FlexDocContainer>
  );
  ...
  return (
    <FlexDocContainer name={props.name.toString()} prefix="flex-grow">
      <div className="d-flex align-items-start grow-shrink-container">
        <div className={`p-12 flex-grow-${props.name}`}>
...
export function WrapContainer(props: { name: string }) {
  return (
    <FlexDocContainer name={props.name} prefix="flex">
      <div className={`d-flex flex-${props.name}`}>
        <div className="p-12">Content 1</div>
        <div className="p-12">Content 2</div>
        <div className="p-12">Content 3</div>
        <div className="p-12">Content 4</div>
        <div className="p-12">Content 5</div>
        <div className="p-12">Content 6</div>
        <div className="p-12">Content 7</div>
        <div className="p-12">Content 8</div>
      </div>
    </FlexDocContainer>
  );
}
