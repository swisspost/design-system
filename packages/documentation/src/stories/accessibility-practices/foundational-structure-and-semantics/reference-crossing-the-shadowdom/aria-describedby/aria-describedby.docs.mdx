...
<p>
  ⚠️ The `aria-describedby` attribute is not intended to reference content from external sources.
...
<p>
  `ariaDescribedByElements` is a property of the <a href="https://developer.mozilla.org/fr/docs/Web/API/Element" target="_blank">Element API</a> that returns an array of elements
