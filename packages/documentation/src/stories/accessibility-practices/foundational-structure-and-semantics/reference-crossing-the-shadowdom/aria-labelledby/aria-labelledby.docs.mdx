...
<p>
  ...
  to work, the label element shoul be in the same DOM or in a parent DOM of the target element.
</p>
...
<p>
  ...
  this case <b>all the visible text inside the component that contains the reference will be assigned as the Accessible Name</b> of the target element.
</p>
