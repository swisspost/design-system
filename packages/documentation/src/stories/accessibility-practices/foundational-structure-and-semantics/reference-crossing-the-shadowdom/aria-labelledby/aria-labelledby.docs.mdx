...
An option is to set the `id` directly on the host of the labeling component. Please note that, in this case all the visible text inside the referencing component will be assigned as the Accessible Name of the target element.
