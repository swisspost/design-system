...
<PostBanner type="info">
  ...
  <p>We advise opting for the "Standard HTML" approach for when you need full access to the input
    field and using the "Web Component" method in every other case.</p>
</PostBanner>
