...
<Controls of={CardControlStories.Default} />
    ...
    <post-banner type="warning" data-size="md">
      <h4 slot="heading">Even if it is generally possible, we do not recommend using interactive elements in this slot because the background of the card control is clickable.</h4>
