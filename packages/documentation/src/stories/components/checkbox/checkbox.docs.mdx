...
<Canvas of={checkboxStories.GroupedSmall} />
<div className="hide-col-default">
  <Controls of={checkboxStories.GroupedSmall} />
</div>
...
Use the small variant combined with the `.form-check-inline` class to render small checkboxes in an inline group.

<Canvas of={checkboxStories.InlineSmall} />
<div className="hide-col-default">
  <Controls of={checkboxStories.InlineSmall} />
</div>
