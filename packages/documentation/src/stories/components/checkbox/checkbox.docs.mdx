...
<div class="alert alert-info alert-md">
  There are accessibility issues with grouping form controls.
  <br />
  Please read our{' '}
  <a href="/?path=/docs/foundations-accessibility--page#grouping">grouping accessibility guide</a>.
</div>
...
When the component has been validated, don't forget to add a `<p class="valid-feedback">...</p>` or `<p class="invalid-feedback">...</p>` element after the checkbox element to explain what went wrong. This enables the user to correct the mistake.
