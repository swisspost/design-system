...
If you only want to make content appear like headings without using a semantic element, you should pay attention to our [heading utilities](/?path=/docs/utilities-heading).
