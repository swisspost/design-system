...
<PostTabs>
  <PostTabHeader slot="tabs" panel="typeaheadSampleBasicHtml">template.html</PostTabHeader>
  <PostTabPanel name="typeaheadSampleBasicHtml">
    <Source code={typeaheadSampleBasicHtml} language="html"/>
  </PostTabPanel>

  <PostTabHeader slot="tabs" panel="typeaheadSampleBasicAngular">component.ts</PostTabHeader>
