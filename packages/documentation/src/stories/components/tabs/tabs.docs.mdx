...
Setting the `full-width` property to `true` will allow the tabs container stretch across the full width of the screen, while the tabs and their content remain aligned with the main page content. Click the button below to view a full-screen example of the tabs.
