...
<NgbComponentAlert component="datepicker" src="https://ng-bootstrap.github.io/#/components/datepicker/overview" />
...
<PostTabs>
  <PostTabHeader slot="tabs" panel="floating-label">Floating Label Input</PostTabHeader>
  <PostTabPanel name="floating-label">
    <Source code={datepickerFloatingLabel} language="html"/>
  </PostTabPanel>

  <PostTabHeader slot="tabs" panel="navigation-arrows">Navigation Arrows Only</PostTabHeader>
  <PostTabPanel name="navigation-arrows">
    <Source code={datepickerNavigationArrows} language="html"/>
  </PostTabPanel>

  <PostTabHeader slot="tabs" panel="validation">Invalid Feedback</PostTabHeader>
