...
<post-banner type="info">
  For more information on the dialog element, please refer to the <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog" target="_blank" rel="noopener noreferrer"><strong>MDN Web Docs: HTML &lt;dialog&gt; element</strong></a>.
</post-banner>
