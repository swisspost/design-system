...
.
    ...
    <div className="alert alert-md alert-warning">
      <h4 className="alert-heading">Even if it is generally possible, we do not recommend using interactive elements in this slot because the background of the card control is clickable.</h4>
