...
<div className="alert alert-warning">
  ...
  <ul>
    ...
    <li>**Standard** form elements will support only `.form-select-sm` and the default size.</li>
  </ul>
  <p className="mt-0">`.form-select-rg`, `.form-select-md` and `.form.select-lg` will therefore be completely removed in the next major version.</p>
</div>
