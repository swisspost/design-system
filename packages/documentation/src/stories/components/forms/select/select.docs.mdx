...
<div className="alert alert-warning">
  ...
  <p className="mt-0">`.form-select-rg`, `.form-select-md` and `.form.select-lg` are deprecated and will be removed in the next major version. Only two size variants remain: small and default.</p>
</div>
