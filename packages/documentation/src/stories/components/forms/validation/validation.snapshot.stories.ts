            ...
            html`
              <div class="component-container" style="margin:2rem">
                ...
                ${validationStates.map(state => {
                  ...
                  const validFeedbackId = isValidationSet && isValid ? `${state}-id` : nothing;
                  const invalidFeedbackId = isValidationSet && isInvalid ? `${state}-id` : nothing;
                          ...
                          case 'Select':
                            return html`
                              ...
                              <div class="state-wrapper">
                                <select
                                  id="${component.id}"
                                  class="form-select form-select-lg ${isValidationSet ? state : ''}"
                                  aria-invalid=${ariaInvalid}
                                  aria-describedby="${ariaDescribedBy}"
                                >
