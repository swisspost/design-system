...
<div className="alert alert-warning">
  <h4 className="alert-heading">We're deprecating and simplifying size classes for text input, textarea and select:</h4>
  <ul>
    <li>**Floating** form elements will support only the default size (all size modifiers are deprecated).</li>
    <li>**Standard** form elements will support only `.form-control-sm` and the default size.</li>
  </ul>
  <p className="mt-0">`.form-control-rg`, `.form-control-md` and `.form.control-lg` will therefore be completely removed in the next major version.</p>
</div>
