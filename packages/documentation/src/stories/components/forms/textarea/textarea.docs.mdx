...
<div className="alert alert-warning">
  <h4 className="alert-heading">We're deprecating the regular, medium and large size classes for text input, textarea and select.</h4>
  <p className="mt-0">This will make it easier to select the appropriate size variant: small for internal applications, large (default, no size class) for external applications.<br />
    `.form-control-rg`, `.form-control-md` and `.form.control-lg` are deprecated and will be removed in the next major version.</p>
</div>
