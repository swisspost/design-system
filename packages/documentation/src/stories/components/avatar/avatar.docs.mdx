...
You can customize the avatar’s text color, background color, and size via CSS using the following custom properties.

<div className="banner banner-warning banner-md mb-12">
  Please always ensure the background and foreground colors have sufficient contrast.
</div>
