...
<div className="alert alert-info alert-md">
  If you want to use our [icon component](/?path=/docs/components-icons-icon-component--docs) to
  render the icons (which we strongly recommend), you must also install the
  <strong>components</strong> package.
  <br />
  To learn how to set up this package please read our [Components - Getting Started](/?path=/docs/getting-started-components--docs) page.
</div>
