...
**An `aria-current="page"` attribute must be applied by your application logic to indicate the active page.**
...
Once applied, potential parent items in the navigation automatically inherit the correct selected styling.
