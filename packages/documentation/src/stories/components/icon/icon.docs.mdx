...
Our `<post-icon>` component renders SVGs, so it scales quickly and easily and can be styled with CSS.<br/>
More Informations about the icons can be found under the [Icons Package](/?path=/docs/get-started-icons--page) documentation or the [Icon Search](/?path=/docs/foundations-icons--page).
...
<Canvas dark withSource="open">
  <Story id="components-icon--size" />
</Canvas>

### Style

With the use of our [border](#TODO), [background](/?path=/docs/utilities-background--page) and [padding](#TODO) utilities, you can create various styling effects.

<Canvas dark withSource="open">
  <Story id="components-icon--style" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="components-icon--scale" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="components-icon--rotate" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="components-icon--animate" />
</Canvas>
