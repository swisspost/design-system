...
<PostAlert type="info">
  ...
  <p>
    We advise using the "Web Component" method for all alert use cases.
    The "Standard HTML" approach is deprecated and will be removed in the next major version.
  </p>
</PostAlert>
...
<PostTabs>
    ...
    <PostTabPanel name="standardHTML">
      <PostAlert type="warning">
        The "Standard HTML" alert is deprecated and will be removed in a future version.
      </PostAlert>
