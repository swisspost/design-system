...
<PostAlert type="info">
  ...
  <p>
    ...
    The "Standard HTML" approach is deprecated and will be removed in next major version.
  </p>
</PostAlert>
...
<PostTabs>
    ...
    <PostTabPanel name="standardHTML">
      <PostAlert type="warning">
        The alert standard HTML is deprecated and will be removed in a future version.
      </PostAlert>
