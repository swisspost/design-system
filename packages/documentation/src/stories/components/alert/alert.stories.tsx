...
export default {
  ...
  argTypes: {
    ...
    fixed: {
      name: 'Fixed',
      description: 'Adds the fixed styles.<span className="mt-mini alert alert-info alert-sm">Do not forget to add the structural adjustments!</span>',
      control: { type: 'boolean' },
      table: {
        category: 'Variations'
      }
    ...
    action: {
      name: 'Action Buttons',
      description: 'Adds the action button styles.<span className="mt-mini alert alert-info alert-sm">Do not forget to add the structural adjustments!</span>',
      control: { type: 'boolean' },
      table: {
        category: 'Variations'
      }
