...
<PostBanner type="info">
  ...
  <p>We advise opting for the "Standard HTML" approach for banners that remain static on the page and
    using the "Web Component" method for dismissible banners.</p>
</PostBanner>
