...
<PostTabs>
    ...
    <PostTabPanel name="standardHTML">
      ...
      To present a banner as an banner anchored at the bottom of the page, simply add the class `.banner-fixed-bottom`.
      **These banners are typically designed to be dismissible, therefore it is advisable to employ a web component for their implementation.**

      <Canvas of={BannerStories.Fixed} />
    </PostTabPanel>
    ...
    <PostTabPanel name="webComponent">
      ...
      To present a banner as a banner anchored at the bottom of the page, simply add the `fixed` property.
      Such banners are typically intended to be dismissible.

      <Canvas of={PostBannerStories.Fixed} />
    </PostTabPanel>
