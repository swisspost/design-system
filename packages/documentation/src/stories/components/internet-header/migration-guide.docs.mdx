...
Please refer to the [Internet Header installation instructions](/?path=/docs/components-internet-header-getting-started--docs) for an installation guide.
...
At the [Internet Header configuration page](/?path=/docs/components-internet-header-header--docs) you can find a list of possible options.
