...
Inverted buttons don't need special classes anymore, just use any of the [background classes](/?path=/docs/foundations-color--page) to set the background and you're done for the day.
