...
const meta: MetaComponent = {
  ...
  argTypes: {
    id: {
      name: 'Id',
      description:
        'The id is used to connect a trigger element with the popover. <post-banner data-size="sm">`<button data-popover-target="...">` is the only valid trigger element for `post-popover`.</post-banner>',
      table: {
        category: 'General',
      },
    },
