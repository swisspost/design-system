...
<p className="lead">Tells the user an important information before going on with a further action and allows to interrupt the current action.</p>
...
<PostTabs>
  <PostTabHeader slot="tabs" panel="basicExampleHTML">template.html</PostTabHeader>
  <PostTabPanel name="basicExampleHTML">
    <Source code={basicExampleHTML} language="html"/>
  </PostTabPanel>

  <PostTabHeader slot="tabs" panel="basicExampleAngular">component.ts</PostTabHeader>
