...
const meta: MetaComponent = {
  ...
  argTypes: {
    ...
    validation: {
      name: 'Validation',
      description:
        'Defines the validation state of the textarea and controls the display of the corresponding return message. <post-banner data-size="sm">Please read our <a href="/?path=/docs/1aa900d9-aa65-4ae0-b8cd-e6cca6cc3472--docs#textarea">validation guidelines here</a>.</post-banner> ',
      control: {
        type: 'radio',
        labels: {
          'null': 'Default',
