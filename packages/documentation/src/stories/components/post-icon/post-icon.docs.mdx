...
<Meta title="Components/Post Icon" />
...
<Canvas dark>
  <Story id="components-post-icon--default" />
</Canvas>
<ArgsTable story="^" />
...
<Canvas dark withSource="open">
  <Story id="components-post-icon--color" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="components-post-icon--size" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="components-post-icon--style" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="components-post-icon--flip" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="components-post-icon--scale" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="components-post-icon--rotate" />
</Canvas>
...
<Canvas dark withSource="open">
  <Story id="components-post-icon--animate" />
</Canvas>
