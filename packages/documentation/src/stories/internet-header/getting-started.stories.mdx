...
```typescript
// main.ts / index.js / ...
import { defineCustomElements } from '@swisspost/internet-header/dist/loader';
...
```javascript
// main.js | main.ts
import { defineCustomElements } from 'https://cdn.jsdelivr.net/npm/@swisspost/internet-header@{version}/dist/loader/index.min.js';
...
```javascript
// main.js | main.ts
import { defineCustomElements } from 'https://unpkg.com/@swisspost/internet-header@{version}/dist/loader/index.js';
