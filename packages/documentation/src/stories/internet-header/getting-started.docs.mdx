...
<Source
  code={`npm install @swisspost/internet-header`}
  dark={SourceDarkMode}
  language="bash"
/>

<Source
  code={SampleFrameworks}
  dark={SourceDarkMode}
  language="html"
/>
