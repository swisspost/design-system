...
- - Updated the main Figma link in the `Introduction` page - Restored the list of HTML components in the `Getting Started > Developer` page (by [@leagrdv](https://github.com/leagrdv) with [#6755](https://github.com/swisspost/design-system/pull/6755))
