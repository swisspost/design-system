...
- Fixed the font in the full page previews. (by [@oliverschuerch](https://github.com/oliverschuerch) with [#3465](https://github.com/swisspost/design-system/pull/3465))

- Marked the card button and the carousel as deprecated (will be removed in a future version). (by [@oliverschuerch](https://github.com/oliverschuerch) with [#3465](https://github.com/swisspost/design-system/pull/3465))
