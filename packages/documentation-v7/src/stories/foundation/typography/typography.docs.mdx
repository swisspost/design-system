...
<Meta title="Foundations/Typography" parameters={{ badges: [BADGE.BETA, BADGE.NEEDS_REVISION] }} />

# Typography

This page describes the typography basics of the design system.<br/>
If you want to know how to adjust font-families, font-sizes, etc. in your code, please visit our <LinkTo kind="utilities-text">text utilities docs</LinkTo>.
...
Sometimes the document heading structure requires you to use a heading tag that should look like another in order to maintain a consistency. In those cases you can use the heading helper classes `.h1` through `.h6`.<br/>
For more details, read our <LinkTo kind="components-heading">heading docs</LinkTo>.
...
For more details how to change the look of lists, visit our <LinkTo kind="utilities-list">list utilities docs</LinkTo>.
