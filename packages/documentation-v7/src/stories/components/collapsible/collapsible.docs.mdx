...
<div className="lead">Toggle the visibility of content across your project.</div>
...
<Source
  code={`const collapsible = document.querySelector('#collapsibleId') as HTMLPostCollapsibleElement;
