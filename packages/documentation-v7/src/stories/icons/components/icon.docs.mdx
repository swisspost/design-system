...
You can therefore colorize an icon using our
<LinkTo kind="utilities-text" story="docs">text color utilities</LinkTo>
...
Therefore, you can manage the size of an icon using our
<LinkTo kind="utilities-text" story="docs">font-size utilities</LinkTo>
or by setting the CSS directly through a style attribute or self-defined classes.
...
With the use of our [border](#TODO),
<LinkTo kind="utilities-background" story="docs">background</LinkTo>
