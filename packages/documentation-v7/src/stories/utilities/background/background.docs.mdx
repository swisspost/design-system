...
import * as BackgroundDemos from './background.demo.stories';
...
<Canvas of={BackgroundDemos.ColoredBackground} sourceState='shown' />
...
<Canvas of={BackgroundDemos.NestedBackgrounds} sourceState='shown' />
...
<div className="alert alert-info alert-md">
  ...
  More information on that topic is available on our <LinkTo kind="foundations-accessibility" story="docs">accessibility docs</LinkTo>.
</div>

<Canvas of={BackgroundDemos.TranslucentBackgrounds} sourceState='shown' />
