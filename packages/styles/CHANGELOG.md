...
- Added four new entry files that enable working with Design Tokens:
  ...
  - post-tokens-internal.(s)css: Internal tokens only (by [@gfellerph](https://github.com/gfellerph) with [#3471](https://github.com/swisspost/design-system/pull/3471))

### Patch Changes

- Realigned the checkbox and the radio button with the label. (by [@gfellerph](https://github.com/gfellerph) with [#3471](https://github.com/swisspost/design-system/pull/3471))

- Set the `max-width` constraint of the tag component to 100% for improved accessibility. Try to keep tag text as short as possible though. (by [@gfellerph](https://github.com/gfellerph) with [#3471](https://github.com/swisspost/design-system/pull/3471))
