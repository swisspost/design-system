...
- Fixed scroll functionality on disabled textareas. (by [@alionazherdetska](https://github.com/alionazherdetska) with [#5447](https://github.com/swisspost/design-system/pull/5447))
...
- Fixed an issue where the Stepper started with step 0 on small screen sizes. (by [@alionazherdetska](https://github.com/alionazherdetska) with [#4444](https://github.com/swisspost/design-system/pull/4444))
...
- Fixed issue where the focus ring was not appearing on inactive chips. (by [@schaertim](https://github.com/schaertim) with [#3970](https://github.com/swisspost/design-system/pull/3970))
