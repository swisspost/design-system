...
| `configProxy`             | `config-proxy`               | Define a proxy URL for the config fetch request.                                                                                                                                                                          | `string \| undefined`                                                     | `undefined`                            |
| `customConfig`            | `custom-config`              | <span style="color:red">**[DEPRECATED]**</span> <br/><br/>Customize the header config loaded from the post portal.                                                                                                        | `ICustomConfig \| string \| undefined`                                    | `undefined`                            |
...
| `meta`                    | `meta`                       | <span style="color:red">**[DEPRECATED]**</span> <br/><br/>Toggle the meta navigation.                                                                                                                                     | `boolean`                                                                 | `true`                                 |
...
| `search`                  | `search`                     | <span style="color:red">**[DEPRECATED]**</span> <br/><br/>Toggle the search button.                                                                                                                                       | `boolean`                                                                 | `true`                                 |
| `selfAdminOrigin`         | `self-admin-origin`          | Overrides the selfadmin url in case it needs to differ from the logoutUrl, which is the url that is used by default. The selfadmin url is used in the KLP login widget to set the user menu links.                        | `string \| undefined`                                                     | `undefined`                            |
