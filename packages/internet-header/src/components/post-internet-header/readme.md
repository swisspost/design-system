...
| `selfAdminOrigin`         | `self-admin-origin`          | Overrides the selfadmin url in case it needs to differ from the logoutUrl, which is the url that is used by default.                                                                                                      | `string \| undefined`                                                     | `undefined`                            |
