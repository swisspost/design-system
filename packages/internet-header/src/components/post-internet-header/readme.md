...
| `configProxy`             | `config-proxy`               | DEPRECATED!: Define a proxy URL for the config fetch request. Will be removed in the next major version                                                                                                                   | `null \| string \| undefined`                 | `null`                                 |
