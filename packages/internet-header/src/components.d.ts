...
declare global {
  ...
  interface HTMLPostLanguageSwitchElement
    extends Components.PostLanguageSwitch, HTMLStencilElement {
    addEventListener<K extends keyof HTMLPostLanguageSwitchElementEventMap>(
      type: K,
      listener: (
        this: HTMLPostLanguageSwitchElement,
        ev: PostLanguageSwitchCustomEvent<HTMLPostLanguageSwitchElementEventMap[K]>,
      ) => any,
    ...
    removeEventListener<K extends keyof HTMLPostLanguageSwitchElementEventMap>(
      type: K,
      listener: (
        this: HTMLPostLanguageSwitchElement,
        ev: PostLanguageSwitchCustomEvent<HTMLPostLanguageSwitchElementEventMap[K]>,
