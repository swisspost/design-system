...
declare global {
  ...
  interface HTMLPostKlpLoginWidgetElement
    extends Components.PostKlpLoginWidget, HTMLStencilElement {}
  ...
  interface HTMLPostLanguageSwitch2Element
    extends Components.PostLanguageSwitch2, HTMLStencilElement {
    addEventListener<K extends keyof HTMLPostLanguageSwitch2ElementEventMap>(
      type: K,
      listener: (
        this: HTMLPostLanguageSwitch2Element,
        ev: PostLanguageSwitch2CustomEvent<HTMLPostLanguageSwitch2ElementEventMap[K]>,
      ) => any,
    ...
    removeEventListener<K extends keyof HTMLPostLanguageSwitch2ElementEventMap>(
      type: K,
      listener: (
        this: HTMLPostLanguageSwitch2Element,
        ev: PostLanguageSwitch2CustomEvent<HTMLPostLanguageSwitch2ElementEventMap[K]>,
  ...
  interface HTMLPostMetaNavigationElement
    extends Components.PostMetaNavigation, HTMLStencilElement {}
  ...
  interface HTMLPostSearchElement extends Components.PostSearch, HTMLStencilElement {
    addEventListener<K extends keyof HTMLPostSearchElementEventMap>(
      type: K,
      listener: (
        this: HTMLPostSearchElement,
        ev: PostSearchCustomEvent<HTMLPostSearchElementEventMap[K]>,
      ) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLPostSearchElementEventMap>(
      type: K,
      listener: (
        this: HTMLPostSearchElement,
        ev: PostSearchCustomEvent<HTMLPostSearchElementEventMap[K]>,
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'post-header-logo': LocalJSX.PostHeaderLogo &
        JSXBase.HTMLAttributes<HTMLPostHeaderLogoElement>;
      'post-klp-login-widget': LocalJSX.PostKlpLoginWidget &
        JSXBase.HTMLAttributes<HTMLPostKlpLoginWidgetElement>;
      'post-language-switch-2': LocalJSX.PostLanguageSwitch2 &
        JSXBase.HTMLAttributes<HTMLPostLanguageSwitch2Element>;
      'post-main-navigation': LocalJSX.PostMainNavigation &
        JSXBase.HTMLAttributes<HTMLPostMainNavigationElement>;
      'post-meta-navigation': LocalJSX.PostMetaNavigation &
        JSXBase.HTMLAttributes<HTMLPostMetaNavigationElement>;
      ...
      'swisspost-internet-breadcrumbs': LocalJSX.SwisspostInternetBreadcrumbs &
        JSXBase.HTMLAttributes<HTMLSwisspostInternetBreadcrumbsElement>;
      'swisspost-internet-footer': LocalJSX.SwisspostInternetFooter &
        JSXBase.HTMLAttributes<HTMLSwisspostInternetFooterElement>;
      'swisspost-internet-header': LocalJSX.SwisspostInternetHeader &
