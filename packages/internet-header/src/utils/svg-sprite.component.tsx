...
export const SvgSprite = () => (
  <svg aria-hidden="true" style={{ display: 'none' }}>
    ...
    <symbol id="8000_twitter" viewBox="0 0 32 32">
      <path
        d="m-50.985 27.059 11.325 15.444-11.397 12.556h2.565l9.978-10.993 8.062 10.993h8.729l-11.962-16.312 10.608-11.688h-2.565l-9.189 10.125-7.425-10.125h-8.729zm3.772 1.926h4.01l17.707 24.146h-4.01l-17.707-24.146z"
