...
- Added icons number 2797 and 2798. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#8230](https://github.com/swisspost/design-system/pull/8230))

- Updated icons number 2420 and 2422. Added icons number 2799, 2800 and 2801. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#8270](https://github.com/swisspost/design-system/pull/8270))

## 9.13.0

### Minor Changes

- Added icons number 2785, 2786, 2787, 2788, 2789, 2790, 2791, 2792, 2793, 2794, 2795 and 2796. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7619](https://github.com/swisspost/design-system/pull/7619))

## 9.12.0

### Minor Changes

- Added icon number 2777. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7449](https://github.com/swisspost/design-system/pull/7449))

- Added icons number 2778 and 2779. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7514](https://github.com/swisspost/design-system/pull/7514))

- Added icons number 2780, 2781, 2782, 2783 and 2784. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7554](https://github.com/swisspost/design-system/pull/7554))

## 9.11.0

### Minor Changes

- Added icon number 2765. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7389](https://github.com/swisspost/design-system/pull/7389))

- Added icons number 2730, 2731, 2732, 2733, 2734, 2735, 2736, 2737, 2738, 2739, 2766, 2767, 2768, 2769, 2770, 2771, 2772, 2773, 2774, 2775 and 2776. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7422](https://github.com/swisspost/design-system/pull/7422))

## 9.10.0

### Minor Changes

- Added icons number 2761, 2762, 2763 and 2764. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7342](https://github.com/swisspost/design-system/pull/7342))

## 9.9.0

### Minor Changes

- Added icons number 2754, 2755, 2756, 2757, 2758 and 2759. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7235](https://github.com/swisspost/design-system/pull/7235))

- Added icon number 2760. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7277](https://github.com/swisspost/design-system/pull/7277))
...
- Added icons number 2749, 2750 and 2751. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7068](https://github.com/swisspost/design-system/pull/7068))

- Added icons number 2752 and 2753. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#7113](https://github.com/swisspost/design-system/pull/7113))

## 9.6.0

### Minor Changes

- Added icons number 2742 and 2744. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#6667](https://github.com/swisspost/design-system/pull/6667))

- Added icons number 2745, 2746, 2747 and 2748. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#6808](https://github.com/swisspost/design-system/pull/6808))
...
- Added icon number 2741. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#6609](https://github.com/swisspost/design-system/pull/6609))

## 9.4.0

### Minor Changes

- Added icon number 2740. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#6571](https://github.com/swisspost/design-system/pull/6571))

## 9.3.0

### Minor Changes

- Added icons number 2714 and 2715. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#6337](https://github.com/swisspost/design-system/pull/6337))

- Added icons number 2716, 2717, 2718, 2719, 2720, 2721, 2722, 2723, 2724, 2725, 2726, 2727, 2728 and 2729. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#6424](https://github.com/swisspost/design-system/pull/6424))

## 9.2.0

### Minor Changes

- Added icons number 2645, 2646, 2647, 2648, 2649, 2650, 2651, 2652, 2653, 2654, 2655, 2656, 2657, 2658, 2659, 2661, 2662, 2663, 2664, 2665, 2666, 2667, 2668, 2669, 2670, 2671, 2672, 2673, 2674, 2675, 2676, 2677, 2678, 2679, 2680, 2681, 2682, 2683, 2684, 2685, 2686, 2687, 2688, 2689, 2690, 2691, 2692, 2693, 2694, 2695, 2696, 2697, 2698, 2699, 2700, 2701, 2702, 2703, 2704, 2705, 2706, 2707, 2708, 2709, 2710, 2711, 2712 and 2713. (by [@swisspost-bot](https://github.com/swisspost-bot) with [#6183](https://github.com/swisspost/design-system/pull/6183))
