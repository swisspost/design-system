  ...
  return (
    ...
    <a href="">
      ...
      <li>
        ...
        <PostLanguageMenu textChangeLanguage="Change the language" textCurrentLanguage="The currently selected language is #name." name="language-menu-example" slot="language-menu">
    ...
    <PostMainnavigation slot="main-nav" textMain="Main">
      ...
      <main style={{ paddingBlock: '3rem' }}>
        <div className="container" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          <PostBreadcrumbs homeUrl="/" textHome="Home" textBreadcrumbs="Breadcrumbs" textMoreItems="More items">
