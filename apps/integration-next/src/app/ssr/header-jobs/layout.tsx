  ...
  return (
    ...
    <ul slot="local-nav">
      <li>
        <a href="">
          Jobs Search
          <PostIcon name="search" aria-hidden="true" data-version="10.0.0-next.67" data-hydrated="" />
        </a>
      </li>
      <li>
        <a href="">
          Jobs Login
          <PostIcon name="login" aria-hidden="true" data-version="10.0.0-next.67" data-hydrated="" />
        </a>
      </li>
    </ul>
      </PostHeader>
