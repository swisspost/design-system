  ...
  return (
    <>
      ...
      <PostStepper
        ...
        text-current-step="Current step"
        text-step-number="Step #number:"
        current-index="2"
        selected-index=""
      >
        <PostStepperItem> Step 1 label</PostStepperItem>{' '}
        <PostStepperItem> Step 2 label</PostStepperItem>{' '}
        <PostStepperItem> Step 3 label</PostStepperItem>{' '}
        <PostStepperItem> Step 4 label</PostStepperItem>{' '}
        <PostStepperItem> Step 5 label</PostStepperItem>
      </PostStepper>
