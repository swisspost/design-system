...
export default function Layout({ children }: { readonly children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <PostHeader text-menu="Menu" data-version="10.0.0-next.67" data-color-scheme="light" style={{ ['--post-header-scroll-parent-height']: '1557px' }}>
     ...
     <h1 slot="title">[One Pager Title]</h1> 
      </PostHeader>
