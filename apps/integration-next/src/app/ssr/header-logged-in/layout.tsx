  ...
  return (
    ...
    <a href="">
      ...
      <li>
        ...
        <PostLanguageMenu textChangeLanguage="Change the language" textCurrentLanguage="The currently selected language is #name." slot="language-menu" variant="menu" data-version="10.0.0-next.67">
          <PostLanguageMenuItem code="de" name="German" data-version="10.0.0-next.67" data-hydrated=""><PostMenuItem data-version="10.0.0-next.67" data-hydrated=""><button lang="de">de<span className="visually-hidden">German</span></button></PostMenuItem></PostLanguageMenuItem>
          <PostLanguageMenuItem code="fr" name="French" data-version="10.0.0-next.67" data-hydrated=""><PostMenuItem data-version="10.0.0-next.67" data-hydrated=""><button lang="fr">fr<span className="visually-hidden">French</span></button></PostMenuItem></PostLanguageMenuItem>
          <PostLanguageMenuItem code="it" name="Italian" data-version="10.0.0-next.67" data-hydrated=""><PostMenuItem data-version="10.0.0-next.67" data-hydrated=""><button lang="it">it<span className="visually-hidden">Italian</span></button></PostMenuItem></PostLanguageMenuItem>
          <PostLanguageMenuItem active={true} code="en" name="English" data-version="10.0.0-next.67" data-hydrated=""><PostMenuItem data-version="10.0.0-next.67" data-hydrated=""><button aria-current="true" lang="en">en<span className="visually-hidden">English</span></button></PostMenuItem></PostLanguageMenuItem>
        </PostLanguageMenu>
               <div slot="post-login"> 
    <PostMenuTrigger for="user-menu" data-version="10.0.0-next.67" data-hydrated="">
      <button className="btn btn-link" type="button" aria-haspopup="menu" aria-expanded="false">
        <PostAvatar firstname="John" lastname="Doe" description="Current user is John Doe." data-version="10.0.0-next.67" data-hydrated="" />
        <span className="visually-hidden">Access user links.</span>
      </button>
    </PostMenuTrigger>
    <PostMenu id="user-menu" label="User links" data-version="10.0.0-next.67">
      <div slot="header">
        <PostAvatar firstname="John" lastname="Doe" aria-hidden="true" data-version="10.0.0-next.67" data-hydrated="" />
        John Doe
      </div>
      <PostMenuItem data-version="10.0.0-next.67" data-hydrated="">
        <a href="">
          <PostIcon aria-hidden="true" name="profile" data-version="10.0.0-next.67" data-hydrated="" />
          My Profile
        </a>
      </PostMenuItem>
      <PostMenuItem data-version="10.0.0-next.67" data-hydrated="">
      ...
      <PostMenuItem data-version="10.0.0-next.67" data-hydrated="">
        <a href="">
          <PostIcon aria-hidden="true" name="gear" data-version="10.0.0-next.67" data-hydrated="" />
          Setting
        </a>
      </PostMenuItem>
      <PostMenuItem data-version="10.0.0-next.67" data-hydrated="">
        <button type="button">
          <PostIcon aria-hidden="true" name="logout" data-version="10.0.0-next.67" data-hydrated="" />
          Logout
        </button>
      </PostMenuItem>
    </PostMenu>
    ...
    <PostMainnavigation slot="main-nav" textMain="Main" version="10.0.0-next.67" className="">
      <ul>
        ...
        <li>
          <PostMegadropdownTrigger for="letters" data-version="10.0.0-next.67" data-hydrated="">Letters</PostMegadropdownTrigger>
          <PostMegadropdown id="letters" textClose="Close" textBack="Back" version="10.0.0-next.67">
        ...
        <li>
          <PostMegadropdownTrigger for="packages" data-version="10.0.0-next.67" data-hydrated="">Packages</PostMegadropdownTrigger>
          <PostMegadropdown id="packages" textClose="Close" textBack="Back" version="10.0.0-next.67">
