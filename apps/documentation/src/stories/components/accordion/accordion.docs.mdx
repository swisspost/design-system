...
<p className="lead">An accordion is a vertically stacked list of headers that reveal or hide 
sections of content. It can help organizing content or reduce scrolling when certain content 
is not crucial to be visible by default.</p>
...
<Source
  code={`<post-accordion-item id="my-item">...</post-accordion-item>`}
  language="typescript"
/>
