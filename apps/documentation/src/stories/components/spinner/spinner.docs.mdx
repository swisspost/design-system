...
import meta, * as SpinnerStories from './spinner.stories';
...
<div className="lead">
  The spinner communicates a loading state and indicates that something is being processed. It
  reassures the user that the system is working on their request.
</div>
