...
<p className="lead">Spinners are used to communicate loading states and that something is being processed. They reassure the user that the system is working on their request.</p>
