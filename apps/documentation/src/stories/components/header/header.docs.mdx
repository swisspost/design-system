...
The Application header is a header variant intended for internal applications. It uses the `appearance: compact` configuration and is distinguished by the absence of any content in its global (yellow) part except from the Logo.
