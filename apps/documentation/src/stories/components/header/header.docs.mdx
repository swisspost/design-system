...
is distinguished by the absence of any content in its global (yellow) part except from the Logo. It can be combined with the 
[Side Navigation](/?path=/docs/9f26d86e-7edb-5804-ac96-92g22f91c9d9--docs) for in-app navigation.
