...
The Application header is a header variant intended for internal applications. It uses the `appearance: compact` styles bundle and 
is distinguished by the absence of any content in its global (yellow) part except from the Logo. For applications that require in-app navigation, 
the Application header supports the [Side Navigation](/?path=/docs/9f26d86e-7edb-5804-ac96-92g22f91c9d9--docs).
