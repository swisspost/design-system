...
import SampleCssGlobal from './angular-app-css-global.sample.css?raw';
import changelog from '@/../../../packages/components-angular/projects/components/CHANGELOG.md?raw';
...
<div className="npm-package-link">
  [![npm
  version](https://badge.fury.io/js/@swisspost%2Fdesign-system-components-angular.svg)](https://badge.fury.io/js/@swisspost%2Fdesign-system-components-angular)
</div>
...
<Source code={SampleCssGlobal} language="scss" />
