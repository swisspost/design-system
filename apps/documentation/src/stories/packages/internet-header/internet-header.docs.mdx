...
Everything else, including feature-toggle props, runtime overrides, and language detection helpers, has been removed.
...
Version 10 introduces a set of required props for accessibility purposes, providing visually hidden labels for interactive elements.
They are passed through to the inner Design System components and the component will throw if any are missing.

See the full list of `text-*` props and their descriptions in the [Internet Header documentation](/?path=/story/ebb11274-091b-4cb7-9a3f-3e0451c9a865--docs&viewMode=docs).
