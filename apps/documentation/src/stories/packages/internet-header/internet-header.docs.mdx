...
<post-tabs>
  <post-tab-item name="sass-import">Sass Import</post-tab-item>
  <post-tab-panel for="sass-import">
    <Source
      code={`@use "@swisspost/internet-header/dist/swisspost-internet-header/swisspost-internet-header.css";`}
      dark={SourceDarkScheme}
      language="scss"
    />
  </post-tab-panel>
  <post-tab-item name="html-import">HTML Import</post-tab-item>
  <post-tab-panel for="html-import">
    <Source
      code={`<link rel="stylesheet" href="@swisspost/internet-header/dist/swisspost-internet-header/swisspost-internet-header.css"/>`}
      dark={SourceDarkScheme}
      language="html"
    />
  </post-tab-panel>
...
- For improved semantic markup, consider wrapping the main page content in a `<main>` tag. ([Learn more about the `<main>` tag](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/main)).
